...
<body>
    <!--
        ...
        #3. Add 'data-' prefix for all custom attributes. e.g. data-u="image" -> data-u="image"
    -->
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 1500px;
            ...
            <div>
                <img data-u="image" src="{{asset('contents/images/slider/'.$photo->image)}}" alt="" />
                <div class="slider-img-title">{{$photo->title}}
                </div>
                <div class="slider-img-description">
                        {{$photo->description}}
                </div>
            </div>
            @endforeach
